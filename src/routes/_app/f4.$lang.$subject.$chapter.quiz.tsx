...
function QuizPlaceholderPage() {
  ...
  const title = lang === "bm" ? "Kuiz" : "Quiz";
  const body =
    lang === "bm"
      ? "Kuiz bab ini akan ditambah di sini. Percubaan direkod sebagai senior."
      : "This chapter quiz will go here. Attempts are recorded as senior.";
